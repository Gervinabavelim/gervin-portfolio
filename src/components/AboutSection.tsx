...
const stats = [
  ...
  { value: "847+", label: "GitHub Commits" },
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-20 items-center">
          ...
          >
            ...
            <p className="text-muted leading-relaxed">
              I&apos;m Gervin Abavelim, a software developer based in Manila.
              I specialize in building modern, scalable web applications that
              deliver exceptional user experiences. With a passion for clean
              code and intuitive design, I turn complex problems into elegant
              solutions.
            </p>
            <p className="text-muted leading-relaxed">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 border border-border text-primary px-5 py-2.5 rounded-lg text-sm font-medium hover:border-accent hover:text-accent transition-colors"
              >
                LinkedIn
