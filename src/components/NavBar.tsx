    ...
    >
      <div className="px-6 md:px-16 lg:px-24 py-4 flex items-center justify-between">
        <a
          ...
          className="text-[11px] uppercase tracking-[0.15em] text-cream/80 hover:text-accent transition-colors font-medium"
        >
          Gervin Abavelim
        </a>
        <nav className="flex items-center gap-8">
          {links.map((link) => (
            <a
              ...
              className="text-[11px] uppercase tracking-[0.15em] text-cream/50 hover:text-accent transition-colors"
            >
              {link.label}
            </a>
          ))}
