        ...
        >
          ...
          <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-4">
            <MagneticButton
              ...
              className="inline-flex items-center gap-3 bg-[#1a1a1a] text-white px-8 py-4 text-xs font-semibold tracking-[0.15em] uppercase transition-colors hover:bg-[#333] cursor-pointer"
            >
            ...
            <MagneticButton
              ...
              className="inline-flex items-center gap-3 border border-[#ccc] px-8 py-4 text-xs font-semibold tracking-[0.15em] uppercase text-[#1a1a1a] transition-colors hover:bg-[#eee] cursor-pointer"
            >
